...
== Usage
  ...
  = Using Styles (colors, font-size, etc)
      ...
      2. Specify the locations of where to apply those styles. You can specify a specific row or column. Note that both :row and :column are hashes within :locations. Individual cell support and additional features on their way!
